        ...
        <ul>
          <li class="nav-item nav-item-has-children">
            ...
            <ul id="ddmenu_1" class="collapse show dropdown-nav">
              <li>
                <a href="{{ route('mitra.dashboard', ['id' => $mitra->id_mitra]) }}" class="active"> VolHub </a>
              </li>
            </ul>
          </li>
          <li class="nav-item nav-item-has-children">
            ...
            <ul id="ddmenu_2" class="collapse dropdown-nav">
              <li>
                <a href="{{ route('mitra.kegiatan', ['id' => $mitra->id_mitra]) }}"> Volunteer Listing </a>
              </li>
              <li>
                <a href="{{ route('mitra.pendaftar', ['id' => $mitra->id_mitra]) }}"> All Applicants </a>
              </li>
              <li>
                <a href="{{ route('mitra.edit-profile-page', ['id' => $mitra->id_mitra]) }}"> Company Profile </a>
              </li>
              <li>
                <a href=""> Messages </a>
              </li>
          ...
          <li class="nav-item nav-item-has-children">
            ...
            <ul id="ddmenu_3" class="collapse dropdown-nav">
              <li>
                <a href="{{ route('mitra.logout') }}"> Logout </a>
              </li>
            </ul>
          </li>
        </ul>
