              ...
              <div class="form-signup">
                <div class="form-signup-container">
                  <div class="form-signup-item">
                    ...
                    <input type="text" id="nama" name="nama_mitra" required />
                  </div>
                  <div class="form-signup-item">
                  ...
                  <div class="form-signup-item">
                    ...
                    <input type="email" id="email" name="email_mitra" required />
                  </div>
                  <div class="form-signup-item">
                ...
                <div class="form-signup-container__button">
                  ...
                  <a href="{{route('mitra.login')}}" class="form-signup-button__login">Sudah Punya Akun?</a>
                </div>
              </div>
            </form>
          </main>
