    ...
    <a href="" class="block p-2 border-b hover:bg-gray-100 cursor-pointer md:w-5/12 md:border lg:w-1/4">
        <div class="flex items-center gap-2 px-2">
            ...
            <div>
                ...
                @else
                <p class="text-gray-500 text-sm">Employer has not provided the data yet.</p>
                @endif
            </div>
        </div>
        <div class="flex flex-col px-4 mt-4">
            <div class="flex items-end gap-2">
                <svg class="w-5 fill-slate-500" viewBox="0 -4.91 122.88 122.88" xmlns="http://www.w3.org/2000/svg"
                ...
                <span class="block text-sm leading-none">{{ $mitra->industri }}</span>
                @else
                <span class="block text-sm leading-none">Employer has not provided the data yet.</span>
                @endif
            </div>
            <div class="flex items-end gap-2">
                <svg class="w-5 fill-slate-500" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
                    <path
                ...
                <span class="block text-sm leading-none">{{ $mitra->kegiatans_count }} Lowongan</span>
            </div>
        </div>
    </a>
    @endforeach
