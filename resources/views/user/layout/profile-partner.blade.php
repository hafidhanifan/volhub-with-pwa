...
<section class="mt-20 md:flex md:pt-4 gap-4 flex-wrap justify-center">
    ...
    <a href="../public/detail_mitra.html"
        ...
        <div class="flex items-center gap-2 px-2">
            <img src="../src/image/mitra-logo-2.jpg" alt="" class="max-w-16" />
            <div class="">
                <p class="font-semibold">Volunteer Com.</p>
                <p class="text-gray-500 text-sm">
                    Kab. Demak, Jawa Tengah, Indonesia
                </p>
            </div>
        </div>
    ...
    <a href="../public/detail_mitra.html"
        ...
        <div class="flex flex-col px-4 mt-4">
            <div class="flex items-end gap-2">
                ...
                <span class="block leading-none">Kebersihan</span>
            </div>
            <div class="flex items-end gap-2">
                <svg class="w-6 fill-slate-500" fill="#000000" viewBox="0 0 32 32" version="1.1"
                    xmlns="http://www.w3.org/2000/svg">
                ...
                <span class="block leading-none">90 Lowongan</span>
            </div>
        </div>
    </a>
    <!-- Mitra Card -->
