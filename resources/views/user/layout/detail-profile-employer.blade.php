    ...
    <div class="mt-20 md:w-3/4 md:mx-auto bg-white">
        ...
        <div class="relative">
            ...
            <div class="absolute -top-12 left-4">
                <img src="../src/image/mitra-logo-3.jpg"
        ...
        <div class="mt-14 px-4">
            <div class="flex flex-col md:items-center md:flex-row md:justify-between">
                <h1 class="font-semibold text-xl">PT Dicoding Indonesia</h1>
                <a href="https://www.dicoding.com/"
                    class="text-sm text-sky-600 hover:text-sky-700">https://www.dicoding.com/</a>
            </div>
            <div>
                <span class="text-gray-500 font-light">Kota Yogyakarta, Indonesia</span>
            </div>
            <div>
                <span class="text-gray-500 font-light">Industri kesehatan</span>
            </div>
            <div class="mt-2">
                ...
                <div class="flex text-sm items-center gap-2 mt-2">
                    ...
                    <a href="dicoding@gmail.com">dicoding@gmail.com</a>
                </div>
                <div class="flex text-sm items-center gap-2 mt-2">
                    <svg class="w-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
            ...
            <div class="mt-8">
                ...
                <p class="text-justify">
                    ...
                    Doloribus molestias est voluptas ex, minima nulla recusandae
                    maiores. Dolores veritatis placeat at, quia ipsum possimus
                    suscipit quaerat voluptatibus cupiditate autem expedita, iusto
                    perspiciatis esse consequuntur ipsam ab dignissimos laborum
                        ...
                        <div class="w-full">
                            <div class="flex flex-col gap-1">
                                ...
                                <div class="flex gap-1">
                                    <p class="text-sm text-gray-800">Mega Group,</p>
                                    <p class="text-sm text-gray-800">Yogyakarta</p>
                                </div>
