    ...
    <nav class="bg-white border-b border-gray-200 fixed top-0 left-0 w-full z-50">
      <div class="mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex bg-white justify-between h-20">
          ...
          <div class="flex items-center bg-white z-50">
            <img src="../src/image/logoo2.png" alt="Volhub Logo" class="w-16 md:w-20" />
          </div>

          <!-- Navbar untuk layar lebar -->
          <div class="hidden md:flex space-x-8 items-center justify-center w-full">
            <a href="../public/home-fix.html" class="px-6 py-2 rounded-md font-normal hover:bg-button_hover2">Home</a>
            <a href="../public/volunteer-fix.html"
              class="px-6 py-2 rounded-md font-normal hover:bg-button_hover2">Volunteer</a>
            <a href="../public/mitra.html" class="px-6 py-2 rounded-md font-normal hover:bg-button_hover2">Partner</a>
          </div>
          ...
          <div class="flex items-center">
            ...
            <div class="relative hidden md:block w-32">
              ...
              <div id="profile-dropdown"
                ...
                <div class="px-4 py-2">
                  <div class="text-gray-900 font-semibold">Hafid Hanifan</div>
                  <div class="text-gray-500 text-sm overflow-hidden text-ellipsis whitespace-nowrap">
                    <span class="">hafid.hanifan123@gmail.com</span>
                  </div>
                </div>
      ...
      <div id="mobile-menu"
        ...
        <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3">
          ...
          <a href="#" class="block px-3 py-2 text-base font-light rounded-lg hover:bg-button_hover2">Activity</a>
          <a href="#" class="block px-3 py-2 text-base font-light rounded-lg hover:bg-button_hover2">FAQ</a>
    ...
    <div class="mt-8 mx-auto lg:flex gap-8 lg:max-w-6xl xl:max-w-7xl">
      ...
      <section
        ...
        <div id="modalSetting" class="hidden fixed inset-0 items-center justify-center bg-black bg-opacity-50 z-50">
          <div
            class="w-4/5 md:max-w-4xl bg-white border-b-2 rounded-lg shadow-lg h-[70vh] max-h-[90vh] overflow-y-auto">
